<x-view page-header="AFPs">            
   <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            <h3 class="d-flex justify-content-between">
                {{ __('List') }} AFPs
                <a href="/admin/afps/create" class="text-sm mr-5">
                            ...
                            <x-card class="col-12">
                                <x-slot name="header">
                                    <h5>
                                        ...
                                        <a href="{{ route('admin.afps.edit', $afp->id) }}" class="float-right text-warning">
                                ...
                                <div class="d-flex">
                                    @foreach ($afp->employees->split(2) as $split)
                                        <div class="w-50">
