@extends('layouts.app', ['page_header'=>'AFPs', 'page_description'=>__('List').' AFPs!'])
    ...
    <form action="/admin/afps/employees" method="POST">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3>
                    {{ __('List') }} AFPs
                    <a href="/admin/afps/create" class="pull-right"><i class="fa fa-plus"></i> {{ __('Add') }}</a>
                </h3>
                ...
                <div class="box box-danger">
                    <div class="box-header">
                        <h4>
                            {{ __('List of Employees Not Assigned to') }} AFPs
        ...
        <div class="col-sm-3 col-xs-7"
            ...
            <div class="input-group">
                {{ html()->select('afp', $afps->pluck('name', 'id'), null, ['class' => 'form-control select-2']) }}
