@extends('layouts.app', ['page_header'=>'Create Supervisor Users', 'page_description'=>'List of Menu Items'])
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            <div class="box box-primary">
                ...
                {!! Form::open(['route'=>['admin.supervisor_users.store'], 'method'=>'POST', 'class'=>'',
