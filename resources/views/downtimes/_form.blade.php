<div class="row">
    <div class="col-xs-12 col-lg-4">
        <div class="form-group {{ $errors->has('employee_id') ? 'has-error' : null }}">
            ...
            {!! Form::select('employee_id', $downtime->employeeRecentsList->pluck('full_name', 'id'), null,
            ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
    ...
    <div class="col-xs-12 col-lg-4">
        <div class="form-group {{ $errors->has('campaign_id') ? 'has-error' : null }}">
            ...
            {!! Form::select('campaign_id', $downtime->downtimesCampaignsList->pluck('name', 'id'), null,
            ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
    ...
    <div class="col-lg-4">
        ...
        <div class="form-group {{ $errors->has('date') ? 'has-error' : null }}">
            ...
            <date-picker name="date" id="name" value="{{ $downtime->date ?? old('date') }}" format="yyyy-MM-dd"
...
<div class="row">
    ...
    <div class="col-xs-12 col-lg-4">
        <div class="form-group {{ $errors->has('downtime_reason_id') ? 'has-error' : null }}">
            ...
            {!! Form::select('downtime_reason_id', $downtime->downtimesReasonsList->pluck('name', 'id')->toArray(),
            null,
            ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
    ...
    <div class="col-xs-12 col-lg-4">
        <div class="form-group {{ $errors->has('reported_by') ? 'has-error' : null }}">
            ...
            {!! Form::select('reported_by', $downtime->activeSupervisorsList->pluck('name', 'name')->toArray(), null,
            ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
