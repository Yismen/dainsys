@extends('layouts.app', ['page_header'=>'Dowmtimes', 'page_description'=>'Edit Dowmtime.'])
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    {!! Form::model($downtime, ['route'=>['admin.downtimes.update', $downtime->id], 'method'=>'PUT',
                    'class'=>'', 'role'=>'form', 'novalidate'=>true]) !!}
                            ...
                            <ul class="list-group">
                                <div class="col-sm-6">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        optional(optional($downtime->campaign)->project)->name }}
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <strong>Production Time: </strong> {{ number_format($downtime->production_time,
                                        3) }}
                                    </li>
                                </div>
                ...
                <div class="box-footer">
                    <delete-request-button url="{{ route('admin.downtimes.destroy', $downtime->id) }}"
                        redirect-url="{{ route('admin.downtimes.index') }}"></delete-request-button>
                </div>
            </div>
        </div>
    </div>
