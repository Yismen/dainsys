@extends('layouts.app', ['page_header'=>config('dainsys.app_name'), 'page_description'=>'Showing Client
						...
						<td class="text left">
							<ul class="list-group">
								...
								<li class="list-group-item">
									{{ $project->name }}
									<span class="badge bg-info" title="Employees">{{ $project->employees()->count()
										}}</span>
								</li>
								@endforeach
							</ul>
