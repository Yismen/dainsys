...
<div class="form-group row {{ $errors->has('contact_name') ? 'has-error' : null }}">
...
<div class="row">
	<div class="col-sm-6">
		<div class="col-sm-12">
			<div class="form-group row {{ $errors->has('main_phone') ? 'has-error' : null }}">
	...
	<div class="col-sm-6">
		<div class="col-sm-12">
			...
			<div class="form-group row {{ $errors->has('account_number') ? 'has-error' : null }}">
