<div class="row">
	<div class="col-sm-12">
		...
		<div class="form-group row {{ $errors->has('name') ? 'has-error' : null }}">
			{!! Form::label('name', 'Position Name:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
	...
	<div class="col-sm-6">
		<!-- Department -->
		<div class="form-group row {{ $errors->has('department_id') ? 'has-error' : null }}">
			{!! Form::label('department_id', 'Department:', ['class'=>'col-sm-3  col-form-label']) !!}
			<div class="col-sm-9">
	...
	<div class="col-sm-6">
		<!-- Payment Type -->
		<div class="form-group row {{ $errors->has('payment_type_id') ? 'has-error' : null }}">
			{!! Form::label('payment_type_id', 'Payment Type:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
	...
	<div class="col-sm-6">
		<!-- Payment Frequency -->
		<div class="form-group row {{ $errors->has('payment_frequency_id') ? 'has-error' : null }}">
			{!! Form::label('payment_frequency_id', 'Payment Frequency:', ['class'=>'col-sm-3  col-form-label']) !!}
			<div class="col-sm-9">
		...
		<!-- Salary -->
	<div class="col-sm-6">
		<div class="form-group row {{ $errors->has('salary') ? 'has-error' : null }}">
			{!! Form::label('salary', 'Salary:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
