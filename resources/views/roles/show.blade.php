@extends('layouts.app', ['page_header'=>'Roles Management', 'page_description'=>'Manage roles, permissions and menus
items per role.'])
					...
					<div class="col-sm-12">
						<ul class="list-group">
							<li class="list-group-item">
								...
								<a href="{{ route('admin.roles.index') }}" class="pull-right"><i class="fa fa-home"></i>
									List</a>
							</li>
							<li class="list-group-item">
