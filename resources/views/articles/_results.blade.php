...
<article align="center">
    ...
    <div>
        ...
        <i class="fa fa-comment"> </i> <a href="{{ route('articles.show', $article->slug) }}#disqus_thread"
            class="text-primary">Comments</a>
        ...
        {{-- /. Excert --}}
        <br>
        <a href="{{ route('articles.show', $article->slug) }}" class="btn btn-primary">Read Article <i
...
<div class="jumbotron">
    ...
    <p class="text-danger">
    <h1 class="">Oops! No articles found with the criteria provided</h1>
    </p>
</div>
@endunless
<!-- Pager -->
