@extends('layouts.app', ['page_header'=>'Nationalities', 'page_description'=>'List of nationalities of production.'])
        ...
        <div class="col-sm-12">
            ...
            <form action="/admin/nationalities/employees" method="POST">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h4>
                            <a href="{{ route('admin.nationalities.show', $nationality->id) }}" title="Details">{{
                                $nationality->name }}</a>
                            <span class="badge bg-red">{{ $nationality->employees->count() }}</span>
                            <a href="{{ route('admin.nationalities.edit', $nationality->id) }}"
                ...
                <div class="col-sm-4 col-xs-7"
                    style="position: fixed; bottom: 35%; right: 30px; padding: 15px ;  background-color: whitesmoke; border: darkgray; border-style: solid; border-width: thin;">
                    <div class="input-group">
                        {{ Form::select('nationality', $nationalities->pluck('name', 'id'), null, ['class' =>
