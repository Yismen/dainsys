	...
	<div class="well row ">
		...
		<table class="table table-condensed table-hover">
			...
			<tbody>
				...
				<tr>
					<td>
						<a href="{{ route('site_messages.show', $site_message->id) }}">{{ $site_message->customer_name
							}}</a>
					</td>
					<td>
					...
					<td>
						<a href="{{ route('site_messages.edit', $site_message->id) }}" class="btn btn-warning"
							rel="tooltip" title="Edit" data-placement="left">
							<i class="fa fa-edit"></i>
						</a>
						{!! delete_button('site_messages.destroy', $site_message->id, ['class'=>'btn
						btn-danger','label'=>'<i class="fa fa-trash"></i>']) !!}
					</td>
				</tr>
				@endforeach
			</tbody>
