                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="{{ $process_id ? 'input-group' : '' }}">
                                <select
                                    class="form-control {{ $process_id ? 'bg-light-blue' : '' }}"
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            <div class="{{ $site_id ? 'input-group' : '' }}">
                                <select 
                                    class="form-control {{ $site_id ? 'bg-light-blue' : '' }}"
                                    wire:model="site_id"
                                >
                                    <option value="0"></option>
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="{{ $department_id ? 'input-group' : '' }}">
                                <select 
                                    class="form-control {{ $department_id ? 'bg-light-blue' : '' }}"
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="{{ $project_id ? 'input-group' : '' }}">
                                <select 
                                    class="form-control {{ $project_id ? 'bg-light-blue' : '' }}"
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="{{ $position_id ? 'input-group' : '' }}">
                                <select 
                                    class="form-control {{ $position_id ? 'bg-light-blue' : '' }}"
                                    ...
                                    <tbody>
                                        @foreach ($employees_assigned as $employee)
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-xs btn-danger btn-block" wire:click="unAssign({{ $employee->id }})">{{ __('Remove') }}</button>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="box box-danger">
                            <div class="box-body">
                                <h4 class="text-danger">
                                    ...
                                    <button class="btn btn-sm btn-warning pull-right" wire:click="assigAll()">Assign All</button>
                                </h4>
                                    ...
                                    <tbody>
                                        @foreach ($employees_not_assigned as $employee)
                                            <tr>
                                                ...
                                                <td>{{ $employee->position->name }}</td>
                                                <td>
                                                    <button class="btn btn-xs btn-success btn-block" wire:click="assign({{ $employee->id }})">{{ __('Assign') }}</button>
                                                </td>
                                            </tr>
                                        @endforeach
