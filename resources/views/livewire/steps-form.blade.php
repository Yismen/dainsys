<div class="container">
    <!-- Modal -->
    <div class="modal fade" id="stepModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true"
        wire:ignore.self>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group @error('fields.process_id') has-error @enderror">
                                    ...
                                    <select class="form-control" id="process_id" wire:model.lazy="fields.process_id">
                                        <option value=""></option>
                                        @foreach ($processes as $process)
                                        <option value="{{ $process->id }}" wire:key="{{ $process->id }}">{{
                                            $process->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group @error('fields.order') has-error @enderror">
                                    ...
                                    <input type="number" step="1" min="0" class="form-control" id="order"
                                        aria-describedby="helpId" placeholder="" wire:model.lazy="fields.order">
                                    @error('fields.order')
                                    <div class="help-block">
                                        {{ $message }}
                                    </div>
