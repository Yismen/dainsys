            ...
            <table class="table table-bordered table-condensed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>
                            Action
                            <button class="btn btn-primary pull-right" title="Create" wire:click="$emit('wantsCreateProcess')">
                                <i class="fa fa-plus"></i>
                            </button>
                        </th>
                    </tr>
                ...
                <tbody>
                    @foreach ($processes as $process)
                        <tr>
                            ...
                            <td class="col-sm-2">
                                <button class="btn btn-warning btn-block btn-xs" wire:click="$emit('wantsEditProcess', {{ $process->id }})">
