@extends('layouts.app', ['page_header'=>'Employees Missing Photo', 'page_description'=>'Show Details'])
                ...
                <table class="table table-striped table-inverse table-hovered table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ $employee->photo }}" alt="Missing Photo"
                                    style="max-height: 20px; max-width: 20px;">
                            </td>
                            <td>
                                <a href="{{ route('admin.employees.edit', $employee->id) }}" target="__employees"
                                    class="text-warning">
