@extends('layouts.app', ['page_header'=>'Punches', 'page_description'=>'Details for punches.'])
	...
	<table class="table table-condensed table-hover">
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="{{ route('admin.employees.show', $punch->employee->id) }}">{{ $punch->employee->fullName
						}}</a>
				</td>
			</tr>
			{{-- /. Employee --}}
