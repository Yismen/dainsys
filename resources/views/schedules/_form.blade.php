...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group row {{ $errors->has('date') ? 'has-error' : null }}">
		    {!! Form::label('date', ' From Date:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
			    <date-picker
			        name="date" id="name"
			        value="{{ old('date') }}"
	...
	<div class="col-md-6">
		<!-- # of Days -->
		<div class="form-group row {{ $errors->has('days') ? 'has-error' : null }}">
			{!! Form::label('days', '# of Days:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
				{!! Form::input('number', 'days', null, ['class'=>'form-control', 'placeholder'=>'# of Days', 'min' => 0, 'max' => 30]) !!}
				<span class="form-text">The number of days to feed from the date submitted</span>
