		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-sm-6 col-sm-offset-3">
					{!! Form::model($payment_frequency, ['route'=>['admin.payment_frequencies.update',
					$payment_frequency->id], 'method'=>'PUT', 'class'=>'form-horizontal', 'role'=>'form']) !!}
					...
					<delete-request-button
						...
						redirect-url="{{ route('admin.payment_frequencies.index') }}"></delete-request-button>
				</div>
