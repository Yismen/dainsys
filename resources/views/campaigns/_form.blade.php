...
<div class="row">
	...
	<div class="col-sm-6">
		<!-- Project -->
		<div class="form-group row {{ $errors->has('project_id') ? 'has-error' : null }}">
			{!! Form::label('project_id', ' Project:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
...
<div class="row">
	<div class="col-sm-6">
		<!-- Source -->
		<div class="form-group row {{ $errors->has('source_id') ? 'has-error' : null }}">
	...
	<div class="col-sm-6"><!-- Revenue Type -->
		<div class="form-group row {{ $errors->has('revenue_type_id') ? 'has-error' : null }}">
			{!! Form::label('revenue_type_id', ' Revenue Type:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
...
<div class="row">
	<div class="col-sm-6"><!-- Revenue Rate -->
		<div class="form-group row {{ $errors->has('revenue_rate') ? 'has-error' : null }}">
			{!! Form::label('revenue_rate', ' Revenue Rate:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
	...
	<div class="col-sm-6">
		<!-- SPH Goal -->
		<div class="form-group row {{ $errors->has('sph_goal') ? 'has-error' : null }}">
			{!! Form::label('sph_goal', ' SPH Goal:', ['class'=>'col-sm-2  col-form-label']) !!}
			<div class="col-sm-10">
