            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="card card-primary card-outline pad">
                    {!! Form::open(['route'=>['admin.users.change-password'], 'method'=>'POST', 'class'=>'form-horizontal', 'role'=>'form', 'autocomplete'=>"off"]) !!}  
                        ...
                        <!-- Your Old Password -->
                        <div class="form-group row {{ $errors->has('old_password') ? 'has-error' : null }}">
                            {!! Form::label('old_password', 'Your Old Password:', ['class'=>'col-sm-4  col-form-label']) !!}
                            <div class="col-sm-8">
                        ...
                        <!-- Your New Password -->
                        <div class="form-group row {{ $errors->has('new_password') ? 'has-error' : null }}">
                            {!! Form::label('new_password', 'Your New Password:', ['class'=>'col-sm-4  col-form-label']) !!}
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row {{ $errors->has('new_password_confirmation') ? 'has-error' : null }}">
                            {!! Form::label('new_password_confirmation', 'Confirm New Password:', ['class'=>'col-sm-4  col-form-label']) !!}
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 col-sm-offset-2">
                                ...
                                <a class="btn btn-secondary" href="/admin">Cancel <i class="fa fa-home"></i></a>
                            </div>
                        </div>
