@extends('layouts.app', ['page_header'=>'Reset Password', 'page_description'=>'Allow a current user to reset password'])
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="box box-primary pad">
                {!! Form::open(['route'=>['admin.users.change-password'], 'method'=>'POST', 'class'=>'form-horizontal',
                ...
                <div class="form-group {{ $errors->has('old_password') ? 'has-error' : null }}">
                    ...
                    <div class="col-sm-8">
                        {!! Form::input('password', 'old_password', null, ['class'=>'form-control', 'placeholder'=>'Your
                        Old Password']) !!}
                ...
                <div class="form-group {{ $errors->has('new_password') ? 'has-error' : null }}">
                    ...
                    <div class="col-sm-8">
                        {!! Form::input('password', 'new_password', null, ['class'=>'form-control', 'placeholder'=>'Your
                        New Password']) !!}
                ...
                <div class="form-group {{ $errors->has('new_password_confirmation') ? 'has-error' : null }}">
                    {!! Form::label('new_password_confirmation', 'Confirm New Password:', ['class'=>'col-sm-4
                    control-label']) !!}
                    <div class="col-sm-8">
                        {!! Form::input('password', 'new_password_confirmation', null, ['class'=>'form-control',
