@extends('layouts.app', ['page_header'=>'Users', 'page_description'=>'Reset a user\'s password and assign a new one.'])
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="box box-primary">
                ...
                {!! Form::open(['route'=>['admin.users.force_change', $user->id], 'method'=>'POST',
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <h3><strong><i class="fa fa-envelope"></i> New Password: </strong>{{ session('new_password')
                                }}</h3>
                            @endif
                        </div>
                    </div>
