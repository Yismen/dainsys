...
<!-- Username -->
<div class="form-group row {{ $errors->has('username') ? 'has-error' : null }}">
...
<!-- Is Active -->
<div class="form-group row {{ $errors->has('is_active') ? 'has-error' : null }}">
	{!! Form::label('is_active', 'Is Active:', ['class'=>'col-sm-2  col-form-label']) !!}
	<div class="col-sm-10">
...
<!-- Is Admin -->
<div class="form-group row {{ $errors->has('is_admin') ? 'has-error' : null }}">
	{!! Form::label('is_admin', 'Is Admin:', ['class'=>'col-sm-2  col-form-label']) !!}
	<div class="col-sm-10">
		{!! Form::select('is_admin', $user->adminList, null, ['class'=>'form-control', 'id'=>'is_admin'])!!}
		<span class="form-text text-danger">Very dangerous. If you make the user admin it will
