@extends('layouts.app', ['page_header'=>'Inactive Users', 'page_description'=>'Handle
                    ...
                    <div class="box box-danger info-box bg-grey">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">
                                ...
                                <i class="fa fa-circle {{ $user->isOnline() ? 'text-green' : 'text-gray'}}"
                                    title="{{ $user->isOnline() ? 'Online' : 'Away'}}"></i>
                                ...
                                <form action="{{ route('admin.users.inactive-users.restore',  $user->id) }}"
                                    method="post">
                                    @csrf
