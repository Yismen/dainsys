@extends('layouts.app', ['page_header'=>__('Human Resource'), 'page_description'=>"Dashboard."])
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <monthly-attrition :info="{{ collect($attrition) }}" site="{{ $site }}"></monthly-attrition>
                </div>
                @endforeach
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <monthly-rotation :info="{{ collect($rotation) }}" site="{{ $site }}"></monthly-rotation>
                </div>
                @endforeach
            </div>
