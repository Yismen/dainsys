        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header with-border"><h4>Run DGT-4 Report 
                    ...
                    <div class="card-body">
                        {!! Form::open(['/admin/human_resources/dgt4', 'method'=>'POST', 'class'=>'form-horizontal', 'role'=>'form', 'autocomplete'=>"off",  'enctype'=>"multipart/form-data"]) !!}       
                            ...
                            <!-- Select a Month -->
                            <div class="col-sm-6">
                                <div class="form-group row {{ $errors->has('month') ? 'has-error' : null }}">
                                    {!! Form::label('month', 'Select a Month:', ['class'=>'col-sm-4  col-form-label']) !!}
                                    <div class="col-sm-8">
                                        {!! Form::select('month', $months, null, ['class'=>'form-control form-control-sm']) !!}
