@extends('layouts.app', ['page_header'=>'DGT-4', 'page_description'=>'Select a year to run the DGT4 report.'])
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    {!! Form::open(['/admin/human_resources/dgt4', 'method'=>'POST', 'class'=>'form-horizontal',
