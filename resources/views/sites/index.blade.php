@extends('layouts.app', ['page_header'=>'Sites', 'page_description'=>'List of sites of production.'])
            ...
            <form action="/admin/sites/employees" method="POST">
                ...
                <div class="col-sm-4 col-xs-7"
                    ...
                    <div class="input-group">
                        {{ Form::select('site', $sites->pluck('name', 'id'), null, ['class' => 'form-control select-2'])
                        }}
