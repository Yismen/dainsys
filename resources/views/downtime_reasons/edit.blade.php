@extends('layouts.app', ['page_header'=>config('dainsys.app_name'), 'page_description'=>'Edit Downtime Reason ' .
$downtime_reason->name])
...
<div class="col-sm-8 col-sm-offset-2">
	<div class="box box-primary">
		...
		<div class="box-body">
			{!! Form::model($downtime_reason, ['route'=>['admin.downtime_reasons.update', $downtime_reason->id],
