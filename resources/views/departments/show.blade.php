@extends('layouts.app', ['page_header'=>'Departments', 'page_description'=>'Show details of the department.'])
				...
				<table class="table table-condensed">
					<thead>
						<tr>
							<th>Name</th>
							<th class="col-xs-3">
								<a href="{{ route('admin.positions.create') }}"><i class="fa fa-plus"></i> Add
									Position</a>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ route('admin.positions.edit', $position->id) }}"><i
