<div class="row">
    ...
    <div class="col-sm-3">
        <!-- Start -->
        <div class="form-group row {{ $errors->has('start_at') ? 'has-error' : null }}">
    ...
    <div class="col-sm-3">
         <!-- End -->
        <div class="form-group row {{ $errors->has('end_at') ? 'has-error' : null }}">
...
<div class="row">
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('monday') ? 'has-error' : null }}">
    ...
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('tuesday') ? 'has-error' : null }}">
    ...
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('wednesday') ? 'has-error' : null }}">
    ...
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('thursday') ? 'has-error' : null }}">
    ...
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('friday') ? 'has-error' : null }}">
    ...
    <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('saturday') ? 'has-error' : null }}">
...
<div class="row">
   <div class="col-sm-2">
        <div class="form-group row {{ $errors->has('sunday') ? 'has-error' : null }}">
