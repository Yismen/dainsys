    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    {!! Form::model($performance, ['route'=>['admin.performances.update', $performance->id],
                    'method'=>'PUT', 'class'=>'', 'role'=>'form', 'novalidate'=>true]) !!}
                            ...
                            <ul class="list-group">
                                <div class="col-sm-6">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        number_format($performance->production_time, 3) }}
                                    </li>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <li class="list-group-item">
                                        <strong>Billable Time: </strong> {{ number_format($performance->billable_hours,
                                        3) }}
                                    </li>
                ...
                <div class="box-footer">
                    <delete-request-button url="{{ route('admin.performances.destroy', $performance->id) }}"
                        redirect-url="{{ route('admin.performances.index') }}"></delete-request-button>
                </div>
            </div>
        </div>
    </div>
