<div class="row">
    ...
    <div class="col-sm-6">
        <!-- Supervisor -->
        <div class="form-group row {{ $errors->has('supervisor_id') ? 'has-error' : null }}">
    ...
    <div class="col-xs-6">
        <!-- Production Time -->
        <div class="form-group row {{ $errors->has('production_time') ? 'has-error' : null }}">
    ...
    <div class="col-xs-6">
        <!-- Sales -->
        <div class="form-group row {{ $errors->has('transactions') ? 'has-error' : null }}">
    ...
    <div class="col-xs-4">
        <!-- Revenue -->
        <div class="form-group row {{ $errors->has('revenue') ? 'has-error' : null }}">
