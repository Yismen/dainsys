@extends('layouts.app', ['page_header'=>'Performances Data', 'page_description'=>'description'])
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            <div class="box box-primary">
                ...
                {!! Form::open(['route'=>['admin.performances.store'], 'method'=>'POST', 'class'=>'', 'role'=>'form',
                'novalidate'=>true]) !!}
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('employee_id') ? 'has-error' : null }}">
                                ...
                                {!! Form::select('employee_id', $performance->employeeRecentsList->pluck('full_name',
                                'id'), null, ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('campaign_id') ? 'has-error' : null }}">
                                ...
                                {!! Form::select('campaign_id', $performance->downtimesCampaignsList->pluck('name',
                                'id'), null, ['class'=>'form-control select-2', 'placeholder' => '--Select One']) !!}
                            </div>
                        </div>
                        <!-- /Downtime Campaign -->
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('login_time') ? 'has-error' : null }}">
                                ...
                                {!! Form::input('number', 'login_time', null, ['step'=>0.05, 'class'=>'form-control',
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->has('date') ? 'has-error' : null }}">
                                ...
                                'placeholder'=>'Date']) !!} --}}
                                <date-picker name="date" id="name" value="{{ old('date') }}" format="yyyy-MM-dd"
                                    :disable-since-many-days-ago="30"></date-picker>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('downtime_reason_id') ? 'has-error' : null }}">
                                ...
                                {!! Form::select('downtime_reason_id', $performance->downtimesReasonsList->pluck('name',
                                'id')->toArray(), null, ['class'=>'form-control select-2', 'placeholder' => '--Select
                                One']) !!}
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{ $errors->has('reported_by') ? 'has-error' : null }}">
                                ...
                                {!! Form::select('reported_by', $performance->activeSupervisorsList->pluck('name',
                                'name')->toArray(), null, ['class'=>'form-control select-2', 'placeholder' => '--Select
                                One']) !!}
                    ...
                    <table class="table table-condensed table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.performances.edit', $performance->id) }}"
                                        class="text-warning" target="_performance">
