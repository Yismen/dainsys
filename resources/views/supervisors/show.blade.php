@extends('layouts.app', ['page_header'=>'Supervisors', 'page_description'=>'Details'])
				...
				<div class="box-body pad">
					...
					<table class="table table-condensed table-bordered">
						...
						<tbody>
							...
							<tr>
								<td>{{ $employee->id }}</td>
								<td><a href="/admin/employees/{{ $employee->id }}" target="_new">{{ $employee->full_name
										}}</a></td>
								<td>
									<a href="/admin/departments/{{ $employee->position->department->id }}"
										target="_new">
										{{ $employee->position->department->name }}
									</a>
								</td>
								<td>
									<a href="/admin/positions/{{ $employee->position->id }}" target="_new">{{
