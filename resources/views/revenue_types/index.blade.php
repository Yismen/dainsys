@extends('layouts.app', ['page_header'=>'Revenue Types for Logins', 'page_description'=>'Manage the revenue_types
available in order to save the users logins.'])
				...
				<div class="box-body">
					...
					<table class="table table-condensed table-hover">
						...
						<tbody>
							...
							<tr>
								<td>
									<a href="{{ route('admin.revenue_types.show', $revenue_type->id) }}">{{
										ucwords(trim($revenue_type->name ))}}</a>
								</td>
								<td>
