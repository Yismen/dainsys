	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<div class="box box-warning pad">
				...
				{!! Form::model($permission, ['route'=>['admin.permissions.update', $permission->name], 'method'=>'PUT',
				...
				<div class="box-footer">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="form-group">
							<delete-request-button url="{{ route('admin.permissions.destroy', $permission->name) }}"
								redirect-url="{{ route('admin.permissions.index') }}"></delete-request-button>
						</div>
					</div>
				</div>
			</div>
