<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-group row {{ $errors->has('client_id') ? 'has-error' : null }}">
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group row {{ $errors->has('work_date') ? 'has-error' : null }}">
    ...
    <div class="col-sm-6">
        <div class="form-group row {{ $errors->has('score') ? 'has-error' : null }}">
